describe('mm create article', () => {
    ...
    it('Article Sabrina Fontanini', () => {
        ...
        cy.get('#title\\.ru').type('Feliz Navidad')
        ...
        cy.get('#body\\.ru').type('Elfos y renos todo el día con Santa Claus.')
        ...
        cy.get('#title\\.es').type('С Рождеством')
        ...
        cy.get('#body\\.es').type('Эльфы и олени весь день с Дедом Морозом')

        cy.get('select.form-control.form-select.w-full').select('Margherita Meraglino')
