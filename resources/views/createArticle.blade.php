...
<div class="max-w-screen-xl mx-auto">
    ...
    <header class="flex items-center justify-between py-2 border-b">
        ...
        <ul class="inline-flex items-center">
            ...
            <li class="px-2 md:px-4">
                <a href="{{"http://towerb.test/".App::getLocale()."/articles/create"}}" class="text-purple-600 font-semibold hover:text-purple-500">{{__('create')}}</a>
            </li>
            <li class="px-2 md:px-4">
            ...
            <li class="px-2 md:px-4">
                <a href="http://towerb.test/en/articles/create" class="text-gray-500 font-semibold hover:text-purple-500"> EN </a>
            </li>
            <li class="px-2 md:px-4">
                <a href="http://towerb.test/fr/articles/create" class="text-gray-500 font-semibold hover:text-purple-500"> FR </a>
            </li>
            <li class="px-2 md:px-4">
                <a href="http://towerb.test/it/articles/create" class="text-gray-500 font-semibold hover:text-purple-500"> IT </a>
            </li>
            ...
            <div class="flex justify-center px-6 my-12">
                ...
                <div class="w-full xl:w-4/4 lg:w-12/12 flex">
                    ...
                    <div class="w-full lg:w-4/5 bg-white p-5 rounded-lg lg:rounded-l-none">
                        ...
                        <form method='POST' action="{{"http://towerb.test/".App::getLocale()."/articles/"}}">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="3" name='title' id="title"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="6" name='body' id="body"></textarea>
