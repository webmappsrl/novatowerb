...
<div class="max-w-screen-xl mx-auto">
    ...
    <header class="flex items-center justify-between py-2 border-b">
        ...
        <ul class="inline-flex items-center">
            ...
            <li class="px-2 md:px-4">
                <a href="{{"http://towerb.test/".App::getLocale()."/articles/create_all"}}" class="text-purple-600 font-semibold hover:text-purple-500">{{__('create_all')}}</a>
            </li>
            <li class="px-2 md:px-4">
                <a href="http://towerb.test/en/articles/create_all" class="text-gray-500 font-semibold hover:text-purple-500"> EN </a>
            </li>
            <li class="px-2 md:px-4">
                <a href="http://towerb.test/fr/articles/create_all" class="text-gray-500 font-semibold hover:text-purple-500"> FR </a>
            </li>
            <li class="px-2 md:px-4">
                <a href="http://towerb.test/it/articles/create_all" class="text-gray-500 font-semibold hover:text-purple-500"> IT </a>
            </li>
            ...
            <div class="flex justify-center px-6 my-12">
                ...
                <div class="w-full xl:w-4/4 lg:w-12/12 flex">
                    ...
                    <div class="w-full lg:w-4/5 bg-white p-5 rounded-lg lg:rounded-l-none">
                        <h3 class="pt-4 text-2xl text-center">{{__('create')}}</h3>
                        <form method='POST' action="{{"http://towerb.test/".App::getLocale()."/articles_all"}}">
                            @csrf
                            <div class="mb-4">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="username">
                                    User ID
                                </label>
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="1" name='user_id' id="user_id"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="3" name='titleen' id="titleen"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="6" name='bodyen' id="bodyen"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="3" name='titlefr' id="titlefr"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="6" name='bodyfr' id="bodyfr"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="3" name='titleit' id="titleit"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="6" name='bodyit' id="bodyit"></textarea>
